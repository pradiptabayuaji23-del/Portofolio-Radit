...
async function main() {
    ...
    try {
        ...
        // For GLB UV mapping with flipY=false and ClampToEdge:
        // We need to rotate 90° CCW and flip horizontally
        ...
        for(let i=0; i < 40; i++){
            const h = (Math.sin(i * 123) * 0.5 + 0.5) * 80 + 20;
            ctx.fillRect(100 + i * 20, 1130 + (100 - h)/2, 6, h);
        }
        ...
        stream.pipe(out);
        out.on('finish', () => console.log('Fixed texture generated!'));
