...
// Import komponen TechStack yang baru dibuat
  ...
  return (
    <main className="min-h-screen bg-neutral-50 text-neutral-900 selection:bg-neutral-900 selection:text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 pt-32 pb-20 space-y-32">
        ...
        <section
          id="about"
          className="scroll-mt-32 grid grid-cols-1 md:grid-cols-2 gap-12 items-center min-h-[60vh]"
        >
          {/* KOLOM KIRI: Teks */}
          <div className="space-y-1 order-2 md:order-1 flex flex-col justify-center">
            <FadeIn>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-xs font-semibold mb-1 w-fit">
              ...
              <CardSwap delay={3500}>
                  ...
                  <Card customClass="bg-[#1e1e1e] border border-neutral-700 rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="p-5 font-mono text-xs text-gray-300 leading-relaxed">
                      <div className="opacity-50 mb-2">&lt;!-- Structure --&gt;</div>
                      ...
                      <div className="pl-4"><span className="text-blue-400">&lt;h1&gt;</span><span className="text-white">Hello World</span><span className="text-blue-400">&lt;/h1&gt;</span></div>
                  ...
                  <Card customClass="bg-[#1e1e1e] border border-neutral-700 rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="p-5 font-mono text-xs text-gray-300 leading-relaxed">
                      <div className="opacity-50 mb-2">/* Styling */</div>
                  ...
                  <Card customClass="bg-[#1e1e1e] border border-neutral-700 rounded-xl overflow-hidden shadow-2xl">
                    ...
                    <div className="p-5 font-mono text-xs text-gray-300 leading-relaxed">
                      <div className="opacity-50 mb-2">// Logic</div>
        ...
        {/* --- TECH STACK SECTION (PILL STYLE) --- */}
        {/* Menggunakan komponen TechStack baru */}
...
// Pastikan bagian ini tetap ada di dalam file page.tsx agar tidak error 'undefined'
