        ...
        >
          ...
          <div className="space-y-6 flex flex-col justify-center order-1">
            ...
            <FadeIn delay={0.4} className="flex flex-wrap gap-3 md:gap-4 pt-2 md:pt-4">
              ...
              <a href="/cv.pdf" download className="px-5 py-3 bg-white border border-neutral-200 text-neutral-900 rounded-full font-medium hover:bg-neutral-50 transition-all flex items-center gap-2 text-sm md:text-base">
